...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@RequestBody LoginRequest req, HttpServletRequest request, HttpServletResponse response) {
        ...
        // Gắn refresh token vào cookie HttpOnly, secure=false nếu localhost
    ...
    public ResponseEntity<AuthResponse> refresh(HttpServletRequest request, HttpServletResponse response) {
        ...
        // Thay cookie refresh token, secure=false nếu localhost
        boolean isLocalhost = request.getServerName().contains("localhost") || request.getServerName().contains("127.0.0.1");
    ...
    public ResponseEntity<Map<String, String>> logout(HttpServletResponse response) {
        // Xoá cookie refresh_token, secure=false nếu localhost
