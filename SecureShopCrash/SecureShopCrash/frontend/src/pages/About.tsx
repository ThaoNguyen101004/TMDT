  ...
  const timeline = [
    {
      ...
      description: 'Lumière Beauty được thành lập với sứ mệnh mang đến mỹ phẩm chất lượng cho mọi khách hàng Việt Nam.'
    },
    {
      year: '2015',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[400px] bg-gradient-to-r from-purple-600 to-cyan-500 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Về Lumière Beauty</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Lumière Beauty được thành lập từ năm 2009 với mục tiêu đơn giản nhưng đầy ý nghĩa:
                  mang đến sản phẩm làm đẹp tinh tế, an toàn và phù hợp với phụ nữ Việt Nam.
                </p>
                <p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Những cột mốc quan trọng đánh dấu sự phát triển của Lumière Beauty
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Những con người tài năng và tâm huyết đằng sau sự thành công của Lumière Beauty
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Hãy để Lumière Beauty trở thành người bạn đồng hành trong hành trình chăm sóc sắc đẹp
            </p>
