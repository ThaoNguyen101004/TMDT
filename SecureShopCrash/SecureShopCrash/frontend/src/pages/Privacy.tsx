          ...
          >
            <div className="bg-white border-l-4 border-purple-600 p-8 rounded-r-lg shadow-md">
              <p className="text-lg text-gray-700 leading-relaxed">
                Tại Lumière Beauty, chúng tôi cam kết bảo vệ quyền riêng tư và thông tin cá nhân của bạn. 
          ...
          >
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-gray-600 text-center">
                ...
                <a href="mailto:privacy@lumierebeauty.vn" className="text-purple-600 hover:text-purple-700 font-semibold">
                  privacy@lumierebeauty.vn
                </a>
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <a href="mailto:privacy@lumierebeauty.vn" className="hover:underline">privacy@lumierebeauty.vn</a>
              </div>
              <div>
