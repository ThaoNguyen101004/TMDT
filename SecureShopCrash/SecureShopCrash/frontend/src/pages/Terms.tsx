  ...
  const sections = [
    {
      ...
      icon: CheckCircle,
      content: 'Khi truy cập và sử dụng trang web Lumière Beauty, bạn xác nhận rằng bạn đã đọc, hiểu và đồng ý bị ràng buộc bởi các điều khoản này. Nếu bạn không đồng ý với bất kỳ phần nào của các điều khoản, vui lòng không sử dụng dịch vụ của chúng tôi.'
    },
    {
      id: 'account',
          ...
          >
            <div className="bg-white border-l-4 border-purple-600 p-8 rounded-r-lg shadow-md">
              <p className="text-lg text-gray-700 leading-relaxed">
                Chào mừng bạn đến với Lumière Beauty. Bằng việc truy cập và sử dụng website của chúng tôi, 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-4 text-gray-700">
                <p>Trong phạm vi tối đa được pháp luật cho phép, Lumière Beauty sẽ không chịu trách nhiệm về bất kỳ thiệt hại gián tiếp, ngẫu nhiên hoặc hậu quả nào phát sinh từ việc sử dụng dịch vụ.</p>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <a href="mailto:support@lumierebeauty.vn" className="hover:underline">support@lumierebeauty.vn</a>
              </div>
              <div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <p className="text-lg text-gray-600 mb-6">
              Bằng cách sử dụng Lumière Beauty, bạn xác nhận đã đọc và đồng ý với các điều khoản này.
            </p>
            <Link
              to="/privacy"
